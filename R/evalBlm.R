...
#' portfolio <- evalBlm(data = input, blm = c(0, 1), output_file = FALSE, time_limit = 10)
#'
#' @references \itemize{ \item Salgado-Rojas J, Alvarez-Miranda E, Hermoso V,
#'  Garcia-Gonzalo J, Weintraub A. *A mixed integer programming approach
