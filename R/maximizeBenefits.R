...
#' problem_model <- maximizeBenefits(x = problem_data, blm = 1)
#'
#' ## Model summary
#' print(problem_model)
...
#' @export
maximizeBenefits <- function(x, budget = 0, blm = 0, curve = 3, segments = 3, recovery = TRUE) {
  ...
  ## Presolve
  budget <- presolve(x, objective = "maximizeBenefits", recovery, budget)
