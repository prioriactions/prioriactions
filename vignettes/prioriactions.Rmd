...
## 1           sol 9042.132  917.551 4095.117
```
...
## 1           sol             146   0        0.042 Optimal solution (according to gap tolerance: 0)
```
...
```
## Error in base::round(s$data$sol[1:number_of_pu]): non-numeric argument to mathematical function
```
...
```
## Error in inherits(x, c("Solution", "Portfolio")): object 'port' not found
```
